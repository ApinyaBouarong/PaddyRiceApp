...
@RoutePage()
class ChangePasswordProfileRoute extends StatefulWidget {
  const ChangePasswordProfileRoute({Key? key}) : super(key: key);

  @override
  _ChangePasswordRouteState createState() => _ChangePasswordRouteState();
}

class _ChangePasswordRouteState extends State<ChangePasswordProfileRoute> {
  ...
  Future<void> changePassword(String userId, String newPassword) async {
    ...
    if (response.statusCode == 200) {
      ...
      context.router.replaceAll([BottomNavigationRoute(page: 1)]);
    } else {
