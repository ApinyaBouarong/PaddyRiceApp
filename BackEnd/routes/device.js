...
router.get(
  "/devices/:deviceId/target-values",
  deviceController.getTargetValues
);
router.get("/devices/:serialNumber", deviceController.getDeviceBySerialNumber);
router.put(
  "/devices/userID/serialNumber/update",
  deviceController.updateDeviceBySerialNumber
);
router.get("/device/:device/:userID", deviceController.getSerialNumberById);
