...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.icapps.icapps_torch_compat.TorchCompatPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin icapps_torch_compat, com.icapps.icapps_torch_compat.TorchCompatPlugin", e);
    }
    try {
